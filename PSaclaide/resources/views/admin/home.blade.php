			...
			<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
					...
					<ul class="dropdown-menu notif-box" aria-labelledby="navbarDropdown">
						...
						<li>
							<div class="notif-center">
								...
								<a href="#">
									<div class="notif-img"> 
										<img src="{{asset("admin_assets/assets/img/profile2.jpg")}}" alt="Img Profile">
									</div>
									<div class="notif-content">
										<span class="block">
				...
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-user">
						<li>
							<div class="user-box">
								<div class="u-img"><img src="{{asset("admin_assets/assets/img/profile.jpg")}}" alt="user"></div>
								<div class="u-text">
									<h4>Hizrian</h4>
							...
							<div class="dropdown-divider"></div>
							<a class="dropdown-item" href="auth-normal-sign-in.html" onclick="event.preventDefault(); document.getElementById('form_logout').submit()"><i class="fa fa-power-off"></i> Logout</a>
